...
"></script>
	...
	new DataTable('#example', {
      ...
      buttons:  [
			...
			{
				extend:'excel',  titleAttr: "Export to Excel", title : "Senior List"
			}, 
			{
				extend:'pdf', titleAttr: "Export to PDF", title : "Senior List"
			},
			{
				extend: 'print', titleAttr: "Print", title : "Senior List",  
