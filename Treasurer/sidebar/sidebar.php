        ...
        <div class="wrapper">
            ...
            <div class="menu">
                    ...
                    <a class="sub-btn" href="../dashboard/dashbord.php"><i class="fas fa-desktop"></i><span>Dashboard</span>      
                     ...
                     <div class="item ">                   
                        <a  class="sub-btn" href="../pages/form.php"><i class="fas fa-clipboard-list"></i><Span>Report Form</Span></a>
                     </div>

                     <div class="item ">                   
                   <a  class="sub-btn" href="../pages/docsnfees.php"><i class="fas fa-certificate"></i><Span>Document List and Fees</Span></a></div>
                  

                     <div class="item ">                   
                   <a  class="sub-btn" href="../pages/Certificate.php"><i class="fas fa-certificate"></i><Span>Document Report</Span></a></div>
